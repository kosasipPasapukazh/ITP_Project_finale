 ...
 <head>
  ...
  <body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark primary-color bg-primary text-white">
      ...
      <section >
      <div class="container bg-light " style="margin-top:40px;color:black;font-weight:500;margin-bottom:40px;text-align:center">
        <form action="addInsurance" method="post">
    <div class="form-group">
        <label>Add Id of the product</label>
        <input type="number" class="form-control" required="true" name="stock_id" placeholder="Product Id" class="size">
    </div>
    <div class="form-group">
        <label >Total Payment</label>
        <input  type="number"  class="form-control" required="true" name="totalPayment" placeholder="total payment of the product" class="size">
    </div>
    <div class="form-group">
        <label >Last Paid Payment</label>
        <input  type="number"  class="form-control" required="true" name="lastPayment" placeholder="Last paid" class="size">
    </div>
    <div class="form-group">
        <label >Date</label>
        <input  type="date"  class="form-control" required="true" name="date" placeholder="Date of last paid" class="size">
    </div>
    <div class="form-group">
        <label >Remain Payment</label>
        <input  type="number"  class="form-control" required="true" name="remainPayment" placeholder="remain payment" class="size">
    </div>
