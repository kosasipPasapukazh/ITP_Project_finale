...
.btn:hover {
  ...
  <body style="background-color:#EFCFF2">
 ...
 <jsp:include page="header.jsp"></jsp:include>
  ...
  <div class="container">
  <div class="jumbotron"  style="background-color:#EC88F5;">
 ...
 <div class="row" style="margin-left:1px;">
  ...
  <div class="column"  style="width:370px; height:250px; margin-left:80px;">
    <div class="card">
      <div class="card-body">
   ...
   <div class="column"  style="width:370px; height:250px;margin-left:120px;">
    <div class="card">
      <div class="card-body">
