        ...
        <div class="row" style="margin-top: 60px;margin-bottom: 40px;height: 600px">
          <div class="col-lg-4 col-md-8 bg-light" style="padding: 20px" style="position: sticky;">
                    <div class="card" style="width: 25rem;">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Stock insuranc</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                       <a href="ViewInsurancePage.jsp" class="btn btn-dark" style="width: 300px">Go to insurance</a>
                      </div>
                    </div>
                    ...
                    <div class="card" style="width: 25rem;float: left;margin-left: 600px;margin-top: -180px">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">View income statement</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                       <a href="incomeStatementPage.jsp" class="btn btn-dark" style="width:  300px">Go Income Statment</a>
                      </div>
                    </div>
                      
                   
                     <div class="card" style="width: 25rem;float: left;margin-left: 300px;margin-top: 30px">
                      
                      <div class="card-body">
                        <h5 class="card-title">View Sales Details</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                       <a href="orderPayments.jsp" class="btn btn-dark" style="width:  300px">Go Sales</a>
                      </div>
                    </div>
             </div>
